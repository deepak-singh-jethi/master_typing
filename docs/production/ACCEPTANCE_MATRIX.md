...
| J-09 | Targeted recovery and fresh transfer | failed lesson/practice/test | Exact mistakes are trained; only a separate fresh reassessment can verify transfer; route returns safely | automated + manual |
